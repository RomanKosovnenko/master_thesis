...
The genetic algorithm (GA) is the most popular type of EA.
...
Figure~\label{fig:MutationVector} presented a simple mutation on the chromosome that described as a vector of bits.
