...
\end{figure}
To confirm this idea, a correlation analysis was made and showed in Figure~\ref{fig:CorrelationAnalysis}. Colors indicate the level of correlation. Blue is the inverse correlation, and red is the direct correlation.
...
\begin{figure}
	...
	\caption[]]{}
	\label{fig:CrossoverRateVsutationRate}
\end{figure}
\begin{figure}
	\centering
...
The Figure~\ref{fig:CrossoverRateVsutationRate} shows that valid, or close to valid results exist for all values of described parameters.
...
\begin{figure}
	\ffigbox[]%
	{\begin{subfloatrow}%
			{\fbox{\includegraphics[width=0.5\textwidth]{images/populationSize_gradientBig.png}}}%
			{\caption[]{}\label{fig:populationSize_gradientBig}}%
			
			{\fbox{\includegraphics[width=0.5\textwidth]{images/populationSize_gradientSmall.png}}}%
			{\caption[]{}\label{fig:populationSize_gradientSmall}}%
	\end{subfloatrow}}%
